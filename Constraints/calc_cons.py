...
# global variables
step_max, step_min = GLOBALS.step_max, GLOBALS.step_min
x0, t = GLOBALS.x0, GLOBALS.t
obs, n_obs, obs_rad = GLOBALS.obs, GLOBALS.n_obs, GLOBALS.obs_rad
Pmid = GLOBALS.Pmid
turn_r = GLOBALS.turn_r # minimum turn radius
num_path, Dynamic_Obstacles, uav_ws = GLOBALS.num_path, GLOBALS.Dynamic_Obstacles, GLOBALS.uav_ws
